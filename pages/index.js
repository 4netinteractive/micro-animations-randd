      ...
      <Layout>
        ...
        <main>
          <section className='section'>
            <h1>Images (lazyloading: devtools &gt; slow down internet speed placeholder & tilt)</h1>
          ...
          <section className='section'>
            <h1>Links</h1>
            <a href="/route2" className='link --animated'>Dit is een link</a><br></br>
          </section>
          <section className='section'>
            <h1>Icons</h1>
            <svg className='icon icon--shaking' xmlns="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 512 512" enableBackground="new 0 0 512 512" width={20}>
              <g>
                <g>
